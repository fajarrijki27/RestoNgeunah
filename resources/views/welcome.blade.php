...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
                ...
                <h1 class="sitename">RestoNgeunah</h1>
            </a>
    ...
    <main class="main">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="img-container">
                                        <img src="{{ asset('templates/assets/img/restaurant/misc-square-1.webp') }}"
                                            alt="Restaurant Ambience">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-container">
                                        <img src="{{ asset('templates/assets/img/restaurant/misc-square-2.webp') }}"
                                            alt="Signature Dish">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-container">
                                        <img src="{{ asset('templates/assets/img/restaurant/misc-square-3.webp') }}"
                                            alt="Expert Chefs">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row align-items-center gy-4">
                        ...
                        <div class="about-content">
                            ...
                            <div class="chef-signature mt-4">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <img src="{{ asset('templates/assets/img/restaurant/chef-1.webp') }}"
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="300">
                        <div class="about-image-wrapper">
                            <img src="{{ asset('templates/assets/img/restaurant/showcase-4.webp') }}"
                                class="img-fluid main-image shadow" alt="Restaurant Interior">
                            <img src="{{ asset('templates/assets/img/restaurant/showcase-2.webp') }}"
        ...
        <section id="menu" class="menu section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Menu</h2>
                <p>Pilih menu favoritmu dari kategori makanan dan minuman!</p>
            </div>
                ...
                <div class="isotope-layout" data-default-filter="*" data-layout="masonry"
                    ...
                    <div class="menu-container isotope-container row gy-4">
                        @foreach ($masakans as $masakan)
                            <div class="col-lg-6 isotope-item filter-{{ $masakan->kategori_masakan }}">
                                <div class="menu-item d-flex align-items-center gap-4">
                                    <img src="{{ asset('storage/' . $masakan->img) }}"
                                        alt="{{ $masakan->nama_masakan }}" class="menu-img img-fluid rounded-3">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('templates/assets/img/person/person-m-9.webp') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('templates/assets/img/person/person-f-5.webp') }}"
                                        class="testimonial-img" alt="">
                                    <h3>Sara Wilsson</h3>
                                    <h4>Designer</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('templates/assets/img/person/person-f-12.webp') }}"
                                        class="testimonial-img" alt="">
                                    <h3>Jena Karlis</h3>
                                    <h4>Store Owner</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('templates/assets/img/person/person-m-12.webp') }}"
                                        class="testimonial-img" alt="">
                                    <h3>Matt Brandon</h3>
                                    <h4>Freelancer</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('templates/assets/img/person/person-m-13.webp') }}"
                                        class="testimonial-img" alt="">
                                    <h3>John Larson</h3>
                                    <h4>Entrepreneur</h4>
                                </div>
                    ...
                    <div class="col-lg-5">
                        <div class="chef-highlight" data-aos="fade-right" data-aos-delay="200">
                            <figure class="chef-image">
                                <img src="{{ asset('templates/assets/img/restaurant/chef-1.webp') }}"
                                    class="img-fluid" alt="Executive Chef">
                            </figure>
                            <div class="chef-details">
                                ...
                                <div class="chef-signature">
                                    <img src="{{ asset('templates/assets/img/misc/signature-1.webp') }}"
                                        alt="Chef Signature">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="chef-card" data-aos="zoom-in" data-aos-delay="200">
                                        <div class="chef-img">
                                            <img src="{{ asset('templates/assets/img/restaurant/chef-2.webp') }}"
                                                class="img-fluid" alt="Chef Portrait">
                                            <div class="social-links">
                                                <a href="#"><i class="bi bi-instagram"></i></a>
                                ...
                                <div class="col-md-6">
                                    <div class="chef-card" data-aos="zoom-in" data-aos-delay="250">
                                        <div class="chef-img">
                                            <img src="{{ asset('templates/assets/img/restaurant/chef-3.webp') }}"
                                                class="img-fluid" alt="Chef Portrait">
                                            <div class="social-links">
                                                <a href="#"><i class="bi bi-instagram"></i></a>
                                                <a href="#"><i class="bi bi-twitter-x"></i></a>
                                ...
                                <div class="col-md-6">
                                    <div class="chef-card" data-aos="zoom-in" data-aos-delay="300">
                                        <div class="chef-img">
                                            <img src="{{ asset('templates/assets/img/restaurant/chef-4.webp') }}"
                                                class="img-fluid" alt="Chef Portrait">
                                            <div class="social-links">
                                                <a href="#"><i class="bi bi-instagram"></i></a>
                                                <a href="#"><i class="bi bi-twitter-x"></i></a>
                                ...
                                <div class="col-md-6">
                                    <div class="chef-card" data-aos="zoom-in" data-aos-delay="350">
                                        <div class="chef-img">
                                            <img src="{{ asset('templates/assets/img/restaurant/chef-5.webp') }}"
                                                class="img-fluid" alt="Chef Portrait">
                                            <div class="social-links">
                                                <a href="#"><i class="bi bi-instagram"></i></a>
                                                <a href="#"><i class="bi bi-twitter-x"></i></a>
                ...
                <div class="row gy-5 mb-5">
                    ...
                    <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                        <div class="reservation-image">
                            <img src="{{ asset('templates/assets/img/restaurant/showcase-7.webp') }}"
                    ...
                    <div class="row g-3">
                        <div class="col-lg-8">
                            <div class="main-image" data-aos="zoom-in" data-aos-delay="200">
                                <img src="{{ asset('templates/assets/img/restaurant/event-1.webp') }}"
                                    alt="Event Space" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="row g-3">
                                <div class="col-lg-12 col-md-6">
                                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="250">
                                        <img src="{{ asset('templates/assets/img/restaurant/event-5.webp') }}"
                                            alt="Event" class="img-fluid">
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-6">
                                    <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
                                        <img src="{{ asset('templates/assets/img/restaurant/event-7.webp') }}"
                                            alt="Event" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="featured-event-card" data-aos="fade-up" data-aos-delay="250">
                                ...
                                <div class="event-content">
                                    <div class="event-image">
                                        <img src="{{ asset('templates/assets/img/restaurant/event-3.webp') }}"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="featured-event-card" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div class="event-content">
                                    <div class="event-image">
                                        <img src="{{ asset('templates/assets/img/restaurant/event-8.webp') }}"
    ...
    <footer id="footer" class="footer">
            ...
            <div class="row gy-4">
                <div class="col-lg-5 col-md-12 footer-about">
                    <a href="index.html" class="logo d-flex align-items-center">
                        <span class="sitename">RestoNgeunah</span>
                    </a>
        ...
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">RestoNgeunah</strong> <span>All Rights
                    Reserved</span></p>
            <div class="credits">
                ...
                Designed by <a href="https://www.instagram.com/fgxvn70">Jarx</a>
            </div>
        </div>
    ...
    <script src="{{ asset('templates/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
